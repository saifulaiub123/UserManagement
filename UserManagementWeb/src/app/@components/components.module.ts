...
import { CountryActionComponent } from './custom-smart-table-components/country-action/country-action.component';
...
@NgModule({
  ...
  exports: [...COMPONENTS],
  declarations: [...COMPONENTS, CustomNg2CheckboxComponent, BasicActionComponent, CountryActionComponent],
  entryComponents: [
    NgxFilterByNumberComponent,
  ],
})
